...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $properties = [];
        $propertyData = [
            ['title' => 'Appartement moderne à Tunis', 'city' => 'Tunis', 'price' => '150'],
            ['title' => 'Villa avec piscine à Hammamet', 'city' => 'Hammamet', 'price' => '350'],
            ['title' => 'Studio cosy à Sousse', 'city' => 'Sousse', 'price' => '80'],
            ['title' => 'Maison traditionnelle à Sidi Bou Said', 'city' => 'Sidi Bou Said', 'price' => '200'],
            ['title' => 'Loft design à La Marsa', 'city' => 'La Marsa', 'price' => '180'],
        ];
